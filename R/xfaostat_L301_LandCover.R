...
module_xfaostat_L301_LandCover <- function(command, ...) {
  ...
  MODULE_OUTPUTS <-
    c("GCAMDATA_FAOSTAT_LandCover_229Regs_3Covers_1973to2020")
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    # Load FAO RL data and summarize ----
    ...
    RL1_ArableLand %>%
      ...
      bind_rows(RL3_FallowLand) %>% spread(year, value) ->
    ...
    if (OUTPUT_Export_CSV == T) {
      ...
      output_csv_data("GCAMDATA_FAOSTAT_LandCover_229Regs_3Covers_1973to2020",
                      col_type_nonyear = "icicicc",
                      title = "FAO cropland, Temporary Crop (harvested cropland), and fallow area by country_year",
                      unit = "1000 Ha",
                      description = "Data is cleaned and generated by gcamdata-FAOSTAT",
                      code = "RL",
