...
## Supply-utilization
![Negative values are used for demand elements and positive values are used for supply elements. The total supply is equal to the total demand. Residuals (mostly small) indicate the imbalance in the data, mainly implying the quality of the source data](../man/figures/Fig_WorldSUA.png){width=100%}
