...
2023-09-25 
* Good news: It seems FAOSTAT just made the updated Commodity Balance (CB) dataset available. Previously, it only inlcudes data up to 2013, i.e., consistent with FBSH. It is now adding a new dataset that include data from 2010-2020, consistent with FBH.
* However: 
